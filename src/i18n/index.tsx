...
const EN: Record<string, string> = {
  ...
  'Sonómetro': 'Noise meter',
  'Contenido': 'Content',
  'min': 'min',
  'seg': 'sec',
  '¡Tiempo!': 'Time’s up!',
  'toca para editar': 'tap to edit',
  'Haz clic para escribir el tiempo': 'Click to type in the time',
  'Aceptar': 'OK',
  'Un minuto menos': 'One minute less',
  'Un minuto más': 'One minute more',
  'Pausa': 'Pause',
  'Iniciar': 'Start',
  'Demasiado ruido': 'Too much noise',
  'Va subiendo': 'Getting louder',
  'Buen ambiente': 'Good atmosphere',
  'En silencio': 'Quiet',
  'Sin acceso al micrófono': 'No access to the microphone',
  'Medidor de ruido': 'Noise meter',
  'Permite el micrófono en el navegador y vuelve a intentarlo. El sonido no se graba ni sale de este equipo.':
    'Allow the microphone in the browser and try again. The sound is never recorded or sent off this computer.',
  'Mide el nivel de ruido de la clase en tiempo real. El sonido no se graba ni se envía a ningún sitio.':
    'Measures the classroom noise level in real time. The sound is never recorded or sent anywhere.',
  'Activar micrófono': 'Turn on microphone',
  'Límite: {n}': 'Limit: {n}',
  'Ajusta a partir de qué nivel avisa': 'Set the level it warns from',
  'Apagar micrófono': 'Turn off microphone',
  'Ya han salido todos. Reinicia para volver a empezar.': 'Everyone’s had a turn. Reset to start again.',
  'Reiniciar lista': 'Reset list',
  'GIRAR': 'SPIN',
  'Quitar del sorteo (queda 1)': 'Remove from the draw (1 left)',
  'Quitar del sorteo (quedan {n})': 'Remove from the draw ({n} left)',
  'Girando…': 'Spinning…',
  '1 participante': '1 participant',
  '{n} participantes': '{n} participants',
  'Puedes usar el teclado': 'You can use the keyboard',
  'Pega un enlace de YouTube o una web…': 'Paste a YouTube link or a website…',
  'Abrir': 'Open',
  'Recargar': 'Reload',
  'Abrir en el navegador': 'Open in browser',
  'Proyecta un vídeo o una web sin salir de Aula Pro.': 'Project a video or a website without leaving Aula Pro.',
  'Algunas webs no permiten incrustarse; en ese caso usa el botón de abrir en el navegador.':
    'Some websites don’t allow embedding; in that case use the open-in-browser button.',
  'Desactivar lápiz': 'Turn off pen',
  'Dibujar sobre la pantalla': 'Draw on the screen',
  'Dibujando': 'Drawing',
  'Lápiz': 'Pen',
  'Color del lápiz': 'Pen colour',
  ...
  'Recursos': 'Resources',
  'Sesión': 'Lesson',
  'Medidas de respuesta a la inclusión': 'Inclusion response measures',
  'Medidas universales': 'Universal measures',
  'Metodología y desarrollo': 'Methodology and development',
  'Concreción curricular ({area})': 'Curricular specification ({area})',
  ...
  'Distribución de aula': 'Classroom Layout',
  'Esta clase todavía no tiene alumnos': 'This class doesn\'t have any students yet',
  'Generar grupos con IA': 'Generate groups with AI',
  'Generar grupos equilibrados con IA': 'Generate balanced groups with AI',
  'Grupos cooperativos, roles y rotación semanal': 'Cooperative groups, roles and weekly rotation',
  'Habla en nombre del grupo y modera el turno de palabra.': 'Speaks for the group and moderates turn-taking.',
  'La IA reparte al alumnado real de esta clase en mesas multinivel: mezcla niveles según la media ponderada, la asistencia y los avisos de cada alumno, sin inventar ninguno.': 'The AI splits this class\'s real students into mixed-level tables: it blends levels using each student\'s weighted average, attendance and flags, without inventing any of it.',
  'Mesa {n}': 'Table {n}',
  ...
  'Responsabilidad de este rol': 'This role\'s responsibility',
  'Responsabilidad': 'Responsibility',
  'Responsable del material': 'Materials Lead',
  'Responsable del tiempo': 'Timekeeper',
  'Rol esta semana': 'Role this week',
  'Rol {n}': 'Role {n}',
  'Rol': 'Role',
  'Roles como se formaron los grupos': 'Roles as the groups were first formed',
  'Roles cooperativos': 'Cooperative roles',
  'Rotación de roles': 'Role rotation',
  'Rotada 1 vez': 'Rotated once',
  'Rotada {n} veces': 'Rotated {n} times',
  'Secretario/a': 'Secretary',
  'Semana anterior': 'Previous week',
  'Semana siguiente': 'Next week',
  'Sin mesa asignada': 'Not seated yet',
  'Toca a un alumno y después un asiento libre para sentarlo. Toca un asiento ocupado para quitar a quien esté ahí.': 'Tap a student and then an empty seat to seat them. Tap an occupied seat to remove whoever is sitting there.',
